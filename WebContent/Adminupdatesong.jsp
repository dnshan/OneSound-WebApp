                ...
                <div class="col-12 col-lg-8">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form id="song-form" action="http://localhost:8090/OneSound/AdminServlet/update" method="GET">
                                <div class="form-group">
                                    <label for="firstname">Artist ID</label>
                                    <input type="text" class="form-control" id="artistid" name="artistid" placeholder="Ex : 456 " required>
                                </div>
                                <div class="form-group">
                                    <label for="firstname">Change Song Name</label>
                                    <input type="text" class="form-control" id="songname" name="songname" placeholder="Ex : 123 " required>
                                </div>

                                <div class="form-group">
                                    <label for="firstname">Duration</label>
                                    <input type="text" class="form-control" id="duration" name="duration" placeholder="Ex : Star boy " required>
                                </div>
                                
                              <!--  <div class="form-group">
                                    <label for="exampleInputEmail1">Duration</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Pop">
...
<!-- ##### Footer Area Start ##### -->
</div> <!-- Closing the div with class "container" -->
