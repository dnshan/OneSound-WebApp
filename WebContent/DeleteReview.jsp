        ...
        <div class="login-form">
                            <form action="deletereview" method="post">
                            	...
                            	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name = "Review Id" value = "<%= reviewid%>" readonly>
                                </div>
                            
                                <div class="form-group">
                                    <label for="firstname">Artist ID</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name = "Artist ID" value = "<%= artistid%>"readonly>
                                </div>

                                <div class="form-group">
                                    <label for="firstname">Song Name</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name = "Song Name" value = "<%= songname%>"readonly>
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Category</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name = "Category" value = "<%= category%>"readonly>
                                </div>
                                
                                <div class="form-group">
                                    <label for="firstname">Duration</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name = "Duration" value = "<%=duration%>"readonly>
                                </div>
                                ...
                                <button type="submit" class="btn oneMusic-btn mt-30" name ="submit">Delete My Account</button>
                            </form>
                        </div>
