...
<head>
    ...
    <!-- Title -->
    <title>One Sound - Artist - addSong</title>
                        ...
                        <div class="login-form">
                            <form action="AddSong" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="songname" placeholder="Ex : Star boy ">
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Catogory</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="category"  placeholder="Pop">
                                    <!-- <small id="emailHelp" class="form-text text-muted"><i class="fa fa-lock mr-2"></i>We'll never share your email with anyone else.</small> -->
                                </div>

                                <div class="form-group">
                                    <label for="firstname">Duration</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="duration" placeholder="00:00:00">
                                </div>
